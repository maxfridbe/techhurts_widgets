...
public class HimawariAnimationActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_himawari_animation);
    ...
    private void showCropDialog() {
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Apply & Refresh", (d, w) -> {
                    ...
                    HimawariFetchReceiver.triggerFetch(this);
                })
        ...
        new Thread(() -> {
            try {
                ...
                if ("mp4".equals(type)) {
                    ...
                    outFile = new File(getCacheDir(), "himawari_animation.mp4");
                    ...
                    outFile = new File(getCacheDir(), "himawari_animation.gif");
                    ...
                    outFile = new File(getCacheDir(), "himawari_latest.webp");
    ...
    private void clearHistory() {
        ...
        HimawariWidgetProvider.updateAllWidgets(this);
        HimawariFetchReceiver.triggerFetch(this);
        finish();
    }
