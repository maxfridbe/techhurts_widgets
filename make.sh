...
for pair in app-weather:WeatherWidget app-calc:Calculator app-goes:GOESEast app-himawari:Himawari8 app-remote:AndroidTVRemoteControl app-timer:Timer widgets:Widgets; do
